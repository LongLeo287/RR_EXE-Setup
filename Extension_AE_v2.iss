...
AppId={{A426DBBD-00AD-4D9D-82A5-EDDC8416252A}

//--------------------------------- NAME OF INSTALL APP ---------------------------------------------//
#define MyAppName "Easify 2 Pro_v2.4.0"
AppName={#MyAppName}           
...
LicenseFile=Extension_AE-PR.txt
...
#define Tutorial "https://www.youtube.com/watch?v=OOvCUrsty5s"
[Run]
