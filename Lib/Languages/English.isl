...
SelectLanguageTitle=Select Setup Language - Chọn Ngôn Ngữ
SelectLanguageLabel=Select the language to use during the installation.
; SelectLanguageLabel3=Chọn ngôn ngữ để sử dụng trong quá trình cài đặt.
...
FinishedHeadingLabel=Completing the [name]
...
Tutorial=Tutorial
Discord=Join Resource && Rookie
CopyrightMessage=Copyright belongs to Resource & Rookie®