...
; *** Câu hỏi khởi nghiệp
PrivilegesRequiredOverrideTitle=Chọn chế độ cài đặt thiết lập
PrivilegesRequiredOverrideInstruction=Chọn Chế độ cài đặt
PrivilegesRequiredOverrideText1=%1 có thể được cài đặt cho tất cả người dùng (yêu cầu administrative đặc quyền), hoặc chỉ dành cho bạn.
PrivilegesRequiredOverrideText2=%1 Chỉ có thể cài đặt cho bạn hoặc cho tất cả người dùng (yêu cầu administrative đặc quyền).
PrivilegesRequiredOverrideAllUsers=Cài đặt cho tất cả người dùng
PrivilegesRequiredOverrideAllUsersRecommended=Cài đặt cho &tất cả người dùng (được đề xuất)
...
CopyrightMessage=Bản quyền thuộc về Resource & Rookie®