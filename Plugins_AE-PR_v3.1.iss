...
#define TheAppId "{{52BB2585-BF88-4A10-9852-C4E99B5DF624}"

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

[Setup]
#define MyAppName "Film Impact Premium Video Transitions"      ; Name for the application
#define MyAppVersion "v5.1.1"
LicenseFile=Information\Plugins_AE-PR.txt                       
...
begin
  ...
  begin
   ...
   ///////////////////////////////////[ Appdata ]/////////////////////////////////
          ...
          #define outputFolder GetEnv("ProgramW6432") + "\Adobe\Common\Plug-ins\7.0\MediaCore\"
          if not DirExists({#outputFolder}) then ForceDirectories({#outputFolder});
          CopyFilesAndFolders(TempDir, '{#outputFolder}', ConfigFileContent);   
