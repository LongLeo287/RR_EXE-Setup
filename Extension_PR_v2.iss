...
AppId={{09602771-63FF-4F38-B7AC-EE6A8D766536}

//--------------------------------- NAME OF INSTALL APP ---------------------------------------------//
#define MyAppName "Transmitter for Premiere Pro_v1.1.0"
AppName={#MyAppName}           
...
#define Tutorial "https://www.youtube.com/watch?v=qqNQMs7Oz6w"
[Run]
