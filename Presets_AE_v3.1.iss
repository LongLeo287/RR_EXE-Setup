...
LicenseFile=Information\Presets_AE.txt                       
...
begin
  ...
  begin
   ...
   ///////////////////////////////////[ Documents ]/////////////////////////////////
    ...
    OutDir := ExpandConstant('{userdocs}\Adobe');
    #define outputSubFolder "\User Presets"
    #define appFolder "After Effects "

      Paths := GetDirectories(OutDir, '{#appFolder}');
      try
